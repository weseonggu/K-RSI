 ...
 * KOSPI 일별 매매 정보 DTO.
 *
 * <p>KRX API 응답을 파싱하여 KOSPI 일별 매매 정보를 담는 DTO입니다.</p>
 *
...
@Builder
@JsonTypeName("KOSPI")
public class KospiTradingInfoDto implements Serializable, TradingInfoDto {
    ...
    /**
     * JSON 데이터 KospiTradingInfoDto로 변환
     * @param stock 일별 매매 정보 데이터
     * @return KospiTradingInfoDto 객체
     */
    public static KospiTradingInfoDto fromJson(Map<String, Object> stock) {
        return KospiTradingInfoDto.builder()
                ...
                .mktNm((String) stock.getOrDefault("MKT_NM", "KOSPI"))
